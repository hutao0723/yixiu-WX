  ...
  async mounted () {
    if (!this.audio.columnId) {
      ...
      const msg = {
          ...
          link: this.audio.courseId ? 'http://k.youfen666.com/#/course/' + this.audio.courseId:false ||this.audio.columnId ? 'http://k.youfen666.com/#/column/' + this.audio.columnId:false ,
