  ...
  methods: {
    async getInfo() {
      ...
      if (res.data.success) {
        ...
        if (!_this.info.bookBgimgUrl) {
          _this.info.bookBgimgUrl =
            "http://yun.dui88.com/yoofans/images/201806/poster_bg.jpg";
        }
        //二维码写死
        _this.info.readQrcodeImgUrl =
          "http://yun.dui88.com/youfen/images/read_ewm3.png";
        _this.createdCanvas();
      } else {
        console.log("获取数据失败");
      }
    ...
    createdCanvas() {
      ...
      let headerImg = new Promise((resolve, reject) => {
        ...
        drawImg.onload = function() {
          ctx.drawImage(
            ...
            0,
            0,
            _this.conversion(750),
            _this.conversion(545)
          );
          resolve();
        };
      });
      ...
      function drawScreen() {
        ...
        ctx.moveTo(
          _this.conversion(34),
          _this.conversion(883) * 1 + responseHeight * 1
        );
        ctx.lineTo(
          _this.conversion(718),
          _this.conversion(883) * 1 + responseHeight * 1
        );
        ctx.stroke();
        // 两个黄色点
        ...
        ctx.arc(
          _this.conversion(93),
          _this.conversion(926) * 1 + responseHeight * 1,
          _this.conversion(7),
          0,
          Math.PI * 2,
          true
        ...
        ctx.arc(
          _this.conversion(93),
          _this.conversion(976) * 1 + responseHeight * 1,
          _this.conversion(7),
          0,
          Math.PI * 2,
          true
        ...
        ctx.fillText(
          "这是我坚持阅读的第" + _this.info.clocks + "天",
          _this.conversion(110),
          _this.conversion(913) * 1 + responseHeight * 1
        );
        ctx.fillText(
          "已坚持阅读" +
            _this.info.books +
            ...
            "分钟",
          _this.conversion(110),
          _this.conversion(963) * 1 + responseHeight * 1
        );
      }
      //绘制二维码
      function createdCode() {
        return new Promise((resolve, reject) => {
          ...
          ctx.fillText(
            "长按识别二维码",
            _this.conversion(227),
            _this.conversion(1109) * 1 + responseHeight * 1
          );
          ctx.fillText(
            "一修读书·" + _this.info.readName,
            _this.conversion(227),
            _this.conversion(1151) * 1 + responseHeight * 1
          );
          let drawImg = new Image();
          drawImg.crossOrigin = "Anonymous";
          ...
          drawImg.onload = function() {
            ctx.drawImage(
              drawImg,
              _this.conversion(80),
              _this.conversion(1057) * 1 + responseHeight * 1,
              _this.conversion(117),
              _this.conversion(117)
            );
            resolve();
          };
      ...
      function createdComma() {
        return new Promise((resolve, reject) => {
          ...
          drawImg.crossOrigin = "Anonymous";
          drawImg.src =
            "http://yun.dui88.com/yoofans/images/201805/read/poster_comma.png";
          drawImg.onload = function() {
            ctx.drawImage(
              drawImg,
              _this.conversion(64),
              _this.conversion(565),
              _this.conversion(80),
              _this.conversion(50)
            );
            resolve();
      ...
      function createdIcon() {
        return new Promise((resolve, reject) => {
          ...
          ctx.fillText(
            "今日读后感",
            _this.conversion(179),
            _this.conversion(405)
          );
          //绘制书名
          ...
          for (let b = 0; b < string_h.length; b++) {
            ctx.fillText(
              string_h[b],
              _this.conversion(179),
              _this.conversion(446) + b * _this.conversion(50)
            );
          }
          let drawImg = new Image();
          drawImg.crossOrigin = "Anonymous";
          ...
          drawImg.onload = function() {
            ...
            ctx.save(); // 保存当前ctx的状态
            ctx.arc(
              _this.conversion(113),
              _this.conversion(443),
              _this.conversion(45),
              0,
              Math.PI * 2,
              true
        ...
        return new Promise((resolve, reject) => {
          ...
          for (let b = 0; b < stringLength.length; b++) {
            ...
            ctx.fillText(
              stringLength[b],
              _this.conversion(78),
              _this.conversion(640) + b * _this.conversion(50)
            );
          }
          //绘制作者信息
          ctx.font = _this.conversion(24) + "px 宋体";
          ...
          ctx.fillText(
            _this.info.userNickname,
            _this.conversion(668) - string_w,
            _this.conversion(640) + stringLength.length * _this.conversion(50)
          );
          //转换时间格式
          ...
          let time =
            ...
            day +
            " " +
            _this.info.releaseTimeLabel;
          string_w = ctx.measureText(time).width;
          ctx.fillText(
            time,
            _this.conversion(668) - string_w,
            _this.conversion(672) + stringLength.length * _this.conversion(50)
          );

          ctx.fillStyle = "#FFF";
          ctx.fillRect(
            _this.conversion(536),
            _this.conversion(320),
            _this.conversion(140),
            _this.conversion(190)
          );
          let drawImg = new Image();
          drawImg.crossOrigin = "Anonymous";
          ...
          drawImg.onload = function() {
            ctx.drawImage(
              drawImg,
              _this.conversion(542),
              _this.conversion(326),
              _this.conversion(128),
              _this.conversion(178)
            );
            resolve();
          };
        });
