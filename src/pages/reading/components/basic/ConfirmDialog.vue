...
export default {
    ...
    methods: {
		 ...
		 * @param text type {String} 	弹窗显示的提示语
		 * @param showCancelButton type {Boolean} 是否显示取消按钮,默认true
		 * @param cancelButtonClass type {String} 取消按钮的class
		 * @param cancelButtonText type {String} 取消按钮的text
		 * @param showConfirmButton type {Boolean} 是否显示确认按钮,默认true
		 * @param confirmButtonClass type {String} 确认按钮的class
		 * @param confirmButtonText type {String} 确认按钮的text
         */
        confirm(obj) {
            this.modalOptions = {
                text: obj.text,
	...
	.modal-dialog .modal-body p{text-align:center;color:#000;}
	.modal-dialog .modal-footer{display:flex;border-top:solid 1px #ccc;}
	.modal-dialog .modal-footer a{flex:1;border-right:solid 1px #ccc;text-align:center;color:#333;display:block;}
